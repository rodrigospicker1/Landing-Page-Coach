    ...
    return (
        ...
        <div className="flex p-0.5 bg-[linear-gradient(to_right,#41974B_0%,#153118_25%,#41974B_62%,#1F4924_94%)] rounded-lg">
                <div className="relative flex rounded-lg">
                    <div className="w-60 bg-gray-900/90 backdrop-filter backdrop-blur-lg p-6 rounded-lg z-2 flex flex-col items-center">
                        <div className="bg-gray-600 w-15 h-15 rounded-full relative flex justify-center items-center mt-[-50px]">
                            <Image 
                                src={img_path}
                                alt=""
                                width={200}
                        ...
                        <div className="p-2 text-xl w-60 text-center text-gray-200 font-semibold">
                            { name }
                        </div>
